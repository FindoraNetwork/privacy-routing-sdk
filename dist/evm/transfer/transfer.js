...
export const fraToBar = async (payload) => {
    const { bridgeAddress, recipientAddress, amount, } = payload;
...
export const frc20ToBar = async (payload) => {
    const { bridgeAddress, recipientAddress, tokenAddress, tokenAmount, } = payload;
    const contract = contracts.prismBridge(bridgeAddress);
